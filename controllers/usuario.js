  ...
  add: async (req, res) => {
    try {
      ...
      if (result.permiso == true) {
        ...
        if (
          regEx.apellido.test(primerApellido) &&
    ...
    try {
      if (req.body.usuario == null || req.body.usuario == "") {
        ...
        req.getConnection((err, conn) => {
          ...
          conn.query(
            `SELECT id, nombre, usuario, password, rolId
